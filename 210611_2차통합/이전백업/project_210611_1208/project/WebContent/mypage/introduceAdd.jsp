...
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/mypage/introduceAdd.css">
...
<body>
	<div id="page">
		...
		<div id="container">
			<section class="plus">
				<form id="inform"
					action="${pageContext.request.contextPath}/introduceAdd.do"
					method="post">
					<article id="point">
						<h2>자기소개서 추가</h2> <span style="color:#aaa;" id="counter">글자 수 (0)</span>
					</article>
					<table>
						<tr>
							<td id="td1" style="width: 20%; background-color: #EAEAEA;">제목</td>
							<td style="background-color: #EAEAEA;"><input type="text"
								style="width: 770px" name="si_ques"></td>
						</tr>
						<tr style="height: 600px;">
							<td id="td1" style="width: 20%; background-color: #EAEAEA;">내용</td>
							<td style="background-color: #EAEAEA;"><textarea
									class="DOC_TEXT" id="si_content" name="si_content"></textarea></td>
						</tr>
					</table>
	...
	<aside id="right">
		<ul>
			...
			<li><a href="#">관심공고</a></li>
			<li><a href="${pageContext.request.contextPath}/mypageSelect.do">회원정보
					수정</a></li>
		</ul>
	</aside>
