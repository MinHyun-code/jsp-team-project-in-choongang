...
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/mypage/introduceSelect.css">
</head>
<body>
<!-- ----------------------- 이력서 -> 자소서 추가 -> 자소서 목록 -> here ------------------- -->
	<div id="page">
		<header>
			<div>
				<h1
					...
					<table>
						...
						<tr style="height: 400px">
							...
							<td style="background-color: #EAEAEA;"><textarea disabled placeholder="id"
									id="content" name="si_content" style="width: 900px; background-color: white">${self.si_content }</textarea></td>
						</tr>
					</table>
