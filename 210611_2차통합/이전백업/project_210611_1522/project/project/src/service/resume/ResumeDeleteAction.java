...
public class ResumeDeleteAction implements CommandProcess {
	...
	public String requestPro(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			result1 = md.resume_intro_delete(r_num, m_id);
			result2 = md.resume_myedu_delete(r_num, m_id);
			result3 = md.resume_licence_delete(r_num, m_id);
			result4 = md.resume_career_delete(r_num, m_id);
