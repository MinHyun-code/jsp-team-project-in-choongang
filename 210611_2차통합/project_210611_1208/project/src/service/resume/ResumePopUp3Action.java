...
public class ResumePopUp3Action implements CommandProcess{
	...
	public String requestPro(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			int eduCnt = md.getEduTotalCnt(replacedWord); // 37
			System.out.println("total>>>>>>>" + eduCnt);
//			String pageNum = request.getParameter("pageNum");
//			if (pageNum == null || pageNum.equals("")) {
//				pageNum = "1";
//			} 
			List<Edu> list = md.listEduSearch(replacedWord);  
...
//			request.setAttribute("endPage", endPage);
			...
			request.setAttribute("eduCnt", eduCnt);
...
//			System.out.println("endPage-->" + endPage); // /ch16/list.do
		...
		return "mypage/resumePopUp3.jsp";
	}
