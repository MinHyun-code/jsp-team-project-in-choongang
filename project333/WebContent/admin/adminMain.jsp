...
<body>
	<div class="admin_set">
	<div class="admin_tap">
		<a onclick="location.href='${pageContext.request.contextPath}/main.jsp'"><div id="admin_img"><img alt="admin.jpg" src="./image/manager.png" style="width: 150px; height: 150px;"></div></a>
		<div id="manager_page">
