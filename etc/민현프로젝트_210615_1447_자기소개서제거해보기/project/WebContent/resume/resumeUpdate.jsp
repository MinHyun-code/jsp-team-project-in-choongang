...
// 	<input type="hidden" name="list_si_num" value=""> <input
// 	type="hidden" name="list_lc_num" value=""> <input
// 	type="hidden" name="list_edu_num" value=""> <input
// 	type="hidden" name="list_edutype_num" value=""> <input
// 	type="hidden" name="list_myedu_sdate" value=""> <input
// 	type="hidden" name="list_myedu_edate" value=""> <input
// 	type="hidden" name="list_career_cr_name" value=""> <input
// 	type="hidden" name="list_career_cr_grade" value=""> <input
// 	type="hidden" name="list_career_cr_salary" value=""> <input
// 	type="hidden" name="list_career_cr_job" value=""> <input
// 	type="hidden" name="list_career_cr_sdate" value=""> <input
// 	type="hidden" name="list_career_cr_edate" value="">
...
<script>
	function addList_si_num(si_num){
		inform.list_si_num.value += si_num + ",";
	}
			...
			<div id="re">
				...
				<div id="top2">
					<a href="${pageContext.request.contextPath}/main.jsp"
						style="cursor: pointer; text-align: center; font-size: 130px; color: #002266; margin-bottom: 40px; text-decoration: none;"><b>다JOB아</b></a>
				</div>
				<div id="top3">
					<div id="top3_1">
						<c:if test="${sessionID == null }">
							<a href="${pageContext.request.contextPath}/join.do"
								style="color: #002266;"><img alt="join.png"
								src="${pageContext.request.contextPath}/image/join.png"
								width="50px" height="50px"><br>JOIN</a>
						</c:if>
						<c:if test="${sessionID != null }">
							<a href="${pageContext.request.contextPath}/logout.do"
								style="color: #002266;"><img alt="logout.png"
								src="${pageContext.request.contextPath}/image/logout.png"
								width="50px" height="50px"><br>LOGOUT</a>
						</c:if>

					</div>
					<div id="top3_2">
						<c:if test="${sessionID == null }">
							<a href="${pageContext.request.contextPath}/log/login.jsp"
								style="color: #002266;"><img alt="login.png"
								src="${pageContext.request.contextPath}/image/login.png"
								width="50px" height="50px"><br>LOGIN</a>
						</c:if>
						<c:if test="${sessionID != null }">
							<a href="${pageContext.request.contextPath}/mypage.do"
								style="color: #002266;"><img alt="my.png"
								src="${pageContext.request.contextPath}/image/my.png"
								width="50px" height="50px"><br>MY</a>
						</c:if>
					</div>
				</div>
			</div>
			<div id="nav">
				<nav>
					<ul id="main-menu">
						...
						<li><a
							href="${pageContext.request.contextPath}/searchHire.do">채용검색</a></li>
						<li><a
							href="${pageContext.request.contextPath}/communityList.do">커뮤니티</a>
							<ul id="sub-menu">
								<li id="asideMenuCommunity"><a
									href="${pageContext.request.contextPath}/communityList.do">커뮤니티</a></li>
								<li id="asideMenuWrite"><a
									href="${pageContext.request.contextPath}/communityWriteForm.do">글
										작성하기</a></li>
								<li id="asideMenuInfo"><a
									href="${pageContext.request.contextPath}/communityList.do?bd_code=1&pageNum=1">정보공유</a></li>
								<li id="asideMenuToktok"><a
									href="${pageContext.request.contextPath}/communityList.do?bd_code=2&pageNum=1">취준톡톡</a></li>
								<!-- 							<li id="asideMenuMyTok"><a href="#">내 질문 보기</a></li> -->
							</ul></li>
						<li><a href="${pageContext.request.contextPath}/mypage.do">마이페이지</a>
							<ul id="sub-menu">
								<li id="asideMenuMyTok"><a
									href="${pageContext.request.contextPath}/mypage.do">마이페이지</a></li>
								<li id="asideMenuCommunity"><a
									href="${pageContext.request.contextPath}/mypageApply.do">지원현황</a></li>
								<li id="asideMenuWrite"><a
									href="${pageContext.request.contextPath}/preferList.do">관심공고</a></li>
								<li id="asideMenuInfo"><a
						...
						<c:if test="${sessionID == null }">
							<li><a
								href="${pageContext.request.contextPath}/log/login.jsp">로그인</a></li>
						</c:if>
					</ul>
				</nav>
			</div>
			...
			<section class="plus">
				<form id="inform"
					...
					<input type="hidden" name="list_si_num" value=""> <input
						...
						type="hidden" name="list_myedu_sdate" value=""> <input
						type="hidden" name="list_myedu_edate" value="">  <input
						type="hidden" name="list_career_cr_name_del" value=""><input
						type="hidden" name="list_career_cr_name" value=""> <input
						type="hidden" name="list_career_cr_grade" value=""> <input
						type="hidden" name="list_career_cr_salary" value=""> <input
						type="hidden" name="list_career_cr_job" value=""> <input
					...
					<table class="tb">
						...
						<tr>
							<td id="td1">첨부파일</td>
							<td id="td2"><input type="file" name="r_file" id="r_file"></td>
						</tr>
						<tr>
							<td id="td1">생년월일</td>
							<td id="td2"><input type="text" class="input" disabled
					...
					<table class="tb" id="edu_tb" style="text-align: center;">
						...
						<c:forEach var="edu_list" items="${edu_list }">
							<tr>
								...
								<td style="width: 100px"><input type="button" value="-" style="font-size: 25px;" class="btn_delete" 
								onclick='javascript:rowDel_1(this);'></td>
							</tr>
						</c:forEach>
					</table>
					<article class="tb_point">
					...
					<table class="tb" id="career_tb" style="text-align: center;">
						...
						<c:forEach var="career_list" items="${career_list }">
							<tr>
								...
								<td style="width: 100px"><input type="button" value="-" style="font-size: 25px;" class="btn_delete"
								onclick='javascript:rowDel_2(this);'></td>
							</tr>
						</c:forEach>
					</table>
					<article class="tb_point">
					...
					<table class="tb" id="licence_tb" style="text-align: center;">
						...
						<c:forEach var="licence_list" items="${licence_list }">
							<tr>
								...
								<td style="width: 100px"><input type="button" value="-" style="font-size: 25px;" class="btn_delete"
								onclick='javascript:rowDel_3(this);'></td>
							</tr>
						</c:forEach>
					</table>
					<article class="tb_point">
					...
					<table class="tb" id="intro_tb" style="text-align: center;">
						...
						<c:forEach var="intro_list" items="${intro_list }">
							<tr>
								...
								<td style="width: 100px"><input type="button" value="-" style="font-size: 25px;" class="btn_delete"
								onclick='javascript:rowDel_4(this); deleteList_si_num(${intro_list.si_num });'></td>
							</tr>
							<script>
