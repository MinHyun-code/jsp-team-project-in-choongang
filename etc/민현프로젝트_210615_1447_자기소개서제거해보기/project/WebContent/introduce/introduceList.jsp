...
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/introduce/introduceList.css">
<link rel="stylesheet"
...
<!-- 							<li id="asideMenuMyTok"><a href="#">내 질문 보기</a></li> -->
			...
			<section class="plus">
				<form id="inform">
					<article id="point" style="margin-top: 70px; margin-bottom: 35px;">
						<h2>자기소개서 관리</h2>
					</article>
					<table class="tb">
						<c:if test="${introCnt > 0 }">
							<c:forEach var="self_intro" items="${list }">
								<tr>
									<td style="text-align: center; font-size: 30px; width: 600px">
