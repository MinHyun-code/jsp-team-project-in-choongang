...
<form action="">
	...
	<div>
		<a href="m_writeForm.do"><input type="button" value="글쓰기" id="write_but"></a>
	</div>
						...
						<c:forEach var="postmember" items="${list }">
							<tr>
								<td class="left">
									...
									<a href='m_content.do?board_no=${postmember.board_no}&post_no=${postmember.post_no }&ref=${postmember.post_no}&post_titile=${postmember.post_title }&pageNum=${currentPage}'>
