...
<!-- 					<td><input type="button" value="취소" class="btn" -->
<%-- 									onclick="location.href='${pageContext.request.contextPath}/mypageApplyDelete.do?rc_num=${allist.rc_num}'" --%>
<!-- 									 style="background-color:#002266; color: white; border-radius: 5px; font-family: Do Hyeon; width: 60px; height:25px;font-size: 20px; "></td> -->
 					<td> 
						<input type="button" value="취소" class="btn" onclick="javascript:cancel(${allist.rc_num}, ${result });">
					</td> 
					</c:if>
...
<!-- 		<script type="text/javascript"> -->
<!--  			alert("지원이 취소되었습니다."); -->
<%-- 		location.href = "${pageContext.request.contextPath}/mypageApply.do"; --%>
<!-- 		</script> -->
<%-- 	</c:if> --%>
<%-- 	<c:if test="${result == 0 }"> --%>
<!-- 		<script type="text/javascript"> -->
