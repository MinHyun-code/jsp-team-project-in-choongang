		...
		<div id="container">
			...
			<div id="wrap">
				...
				<div id="wrap_ap">
					<c:forEach var="i" begin="0" end="3">
						<a href="#" target="_blank"
							onclick="window.open('${pageContext.request.contextPath}/popUpHireUnion.do?union=${list[i].rc_name}','name','resizable=no width=600 height=500'); return false">
							<div id="ap">
				...
				<div id="wrap_in">
					<c:forEach var="i" begin="0" end="3">
						<a href="#" target="_blank"
							onclick="window.open('${pageContext.request.contextPath}/popUpHireUnion.do?union=${list2[i].rc_name}','name','resizable=no width=600 height=500'); return false">
							<div id="in">
				...
				<div id="wrap_my">
					<c:forEach var="i" begin="0" end="3">
						<a href="#" target="_blank"
							onclick="window.open('${pageContext.request.contextPath}/popUpHireUnion.do?union=${rclist[i].rc_name}','name','resizable=no width=600 height=500'); return false">
							<div id="my">
