...
<script>
	...
	function addList_lc_num(lc_num, mylc_date){
		inform.list_lc_num.value += lc_num + ",";
		inform.list_mylc_date.value += mylc_date + ",";
	}
	...
	function addList_edu_num(edu_num, edu_type, myedu_sdate, myedu_edate){
		inform.list_edu_num.value += edu_num + ",";
		inform.list_edutype_num.value += edu_type + ",";
		inform.list_myedu_sdate.value += myedu_sdate + ",";
		inform.list_myedu_edate.value += myedu_edate + ",";
	}
	...
	function addList_career_num(cr_name, cr_grade, cr_salary, cr_job, cr_edate, cr_edate){
		...
		inform.list_career_cr_job.value += cr_job + ",";
			...
			<div id="re">
				...
				<div id="top2">
					<a href="${pageContext.request.contextPath}/main.jsp"
						style="cursor: pointer; text-align: center; font-size: 130px; color: #002266; margin-bottom: 40px; text-decoration: none;">
						<b>다JOB아</b>
					</a>
				</div>
				<div id="top3">
						...
						<c:if test="${sessionID == null }">
							<a href="${pageContext.request.contextPath}/join.do"
								...
								<img alt="join.png"
									...
									width="50px" height="50px"><br>JOIN
							</a>
						</c:if>
						<c:if test="${sessionID != null }">
							<a href="${pageContext.request.contextPath}/logout.do"
								...
								<img alt="logout.png"
									...
									width="50px" height="50px"><br>LOGOUT
							</a>
						</c:if>
						...
						<c:if test="${sessionID == null }">
							<a href="${pageContext.request.contextPath}/log/login.jsp"
								...
								<img alt="login.png"
									...
									width="50px" height="50px"><br>LOGIN
							</a>
						</c:if>
						<c:if test="${sessionID != null }">
		...
		<div id="container">
			<section class="plus">
				<form id="inform"
					...
					<input type="hidden" name="resume_r_pic" value="${resume.r_pic }">
					<article id="point">
						<h2>이력서 추가</h2>
					</article>
						...
						<tr>
							...
							<td id="td2">
								<input type="text" class="input" style="width: 500px"
									name="r_title" value="${resume.r_title }">
							</td>
						</tr>
						<tr>
							<td id="td1">이름</td>
					...
					<table class="tb" id="edu_tb" style="text-align: center;">
						...
						<c:forEach var="edu_list" items="${edu_list }">
							...
							<script>
								addList_edu_num(${edu_list.edu_num},${edu_list.edu_type},'${edu_list.myedu_sdate}','${edu_list.myedu_edate}');
							</script>
						</c:forEach>
					</table>
					<article class="tb_point">
					...
					<table class="tb" id="licence_tb" style="text-align: center;">
						...
						<c:forEach var="licence_list" items="${licence_list }">
							...
							<script>
								addList_lc_num(${licence_list.lc_num}, '${licence_list.mylc_date}');
							</script>
						</c:forEach>
					</table>
					<article class="tb_point">
					...
					<input type="submit" value="저장" style="float: right; margin-top:50px; margin-bottom: 100px;" class="btn	">
				</form>
			</section>
		</div>
