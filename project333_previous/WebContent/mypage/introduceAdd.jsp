		...
		<div id="container">
			<section class="plus">
				<form id="inform"
					...
					<table>
						<tr>
							<td id="td1" style="width: 30%; background-color: #EAEAEA;">제목</td>
							<td style="background-color: #EAEAEA;"><input type="text"
								style="width: 700px" name="si_ques"></td>
						</tr>
						<tr style="height: 600px;">
							<td id="td1" style="width: 30%; background-color: #EAEAEA;">내용</td>
							<td style="background-color: #EAEAEA;"><textarea
									id="content" name="si_content"></textarea></td>
						</tr>
					</table>
