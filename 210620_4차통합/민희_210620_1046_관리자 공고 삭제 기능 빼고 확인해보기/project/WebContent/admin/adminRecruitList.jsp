						...
						<td>${recruit.rc_num}</td>
							<td class="td_main_subject">
								<a href="#" target="_blank"
					             onclick="window.open('${pageContext.request.contextPath}/popUpHireUnion.do?union=${recruit.rc_name}',
					                       'name','resizable=no width=600 height=500');return false">${recruit.rc_name}</a>
							</td>
