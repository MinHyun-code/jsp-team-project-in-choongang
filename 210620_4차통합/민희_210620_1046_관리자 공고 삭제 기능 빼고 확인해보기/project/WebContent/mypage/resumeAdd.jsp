					...
					<table id="resume">
						...
						<tr>
							...
							<td rowspan="3" style="background-color: #EAEAEA;"><img
								alt="사진" id="resume_pic" src="${resume.r_pic }"
						...
						<tr>
							...
							<td colspan="3" style="background-color: #EAEAEA;"><input
								type="text"><button
								onclick="window.open('${pageContext.request.contextPath}/main.jsp', 'width=700, height=630'); return false;">검색</button>
								</td>
						</tr>							
						<tr>
							<td id="td1" style="width: 10%; background-color: #EAEAEA;">전화번호</td>
			...
			<ul>
				<li><a
					href="${pageContext.request.contextPath}/introduceList.do">자기소개서
						관리</a></li>
				<li style="background-color: #235594"><a href="${pageContext.request.contextPath}/resumeList.do">이력서
						관리</a></li>
