...
<body>
	<div id="page">
		...
		<div id="apply3"  style="margin-top: 100px; margin-left: 270px;">
			<h2 style="font-weight: normal;">${rc_name}님의 공고현황입니다.</h2>
		</div>
		<div id="main">
			<table id="table_apply">
				...
				<c:forEach var="allist" items="${list}">
					<tr>
						...
						<td>${allist.rc_salary}만원</td>
						<td><input type="button" value="삭제" class="btn"
										onclick="location.href='${pageContext.request.contextPath}/hireListDelete.do?rc_num=${allist.rc_num}'">
						</td>
					</tr>
				</c:forEach>
			</table>
