					...
					<table  style="margin-bottom: 50px;">
						<tr>
							...
							<td><input id="title" type="text"
								style="width: 770px border: 3px solid #EAEAEA; background-color: white;"  name="si_ques" disabled="disabled" value="${self.si_ques }"></td>
						</tr>
                        ...
                        class="DOC_TEXT" id="si_content" name="si_content" style="width: 674px; max-width: 700px; min-width: 600px; background-color: white;
