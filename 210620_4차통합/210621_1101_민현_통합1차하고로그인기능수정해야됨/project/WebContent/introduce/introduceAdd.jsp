					...
					<table style="margin-bottom: 50px;">
						<tr>
							...
							<td><input id="title" type="text"
								style="width: 770px border: 3px solid #EAEAEA;"  name="si_ques"></td>
						</tr>
						<tr style="height: 500px;">
							<td id="td1" style="width: 20%; ">내용</td>
							<td><textarea
                        class="DOC_TEXT" id="si_content" name="si_content" style="width: 674px; max-width: 700px; min-width: 600px;
