...
<body>
	<div id="page">
		...
		<div id="container">
						<div id="resume_btn"><h2>이력서 관리</h2> <input type="button"  value="+ 이력서 추가" style="cursor:pointer;"
						onclick="location.href='${pageContext.request.contextPath}/resumePreAdd.do'"></div>
					<table class="tb">
						<c:if test="${resumeCnt > 0 }">
							<c:forEach var="resume" items="${list }">
								<tr>
								<td style="text-align: left; font-size: 27px; width:180px;">${resume.r_date}</td>
									<td 
										style="text-align: left; font-size: 27px;">
									...
									<td><input type="button" value="삭제"  style=" border-radius: 100px / 100px; cursor:pointer;"
										onclick="location.href='${pageContext.request.contextPath}/resumeDelete.do?r_num=${resume.r_num}'">
										<input type="button" value="수정"  style=" border-radius: 100px / 100px; cursor:pointer;" 
